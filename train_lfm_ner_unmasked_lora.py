...
training_args = TrainingArguments(
    output_dir="./results_lfm_base_unmasked_lora_8layers",
    eval_strategy="epoch",
    learning_rate=2e-4,
...
print("Starting training for Custom LFM NER (Unmasked Last 8 Layers + LoRA)...")
trainer.train()
...
with open("lfm_unmasked_test_results.json", "w") as f:
